<template>
    <Head>
        <title>Role - Aplikasi Kasir</title>
    </Head>
    <main class="c-main">
        <div class="container-fluid">
            <div class="fade-in">
                <div class="row">
                    <div class="col-md-12">
                        <div class="card border-0 rouded-3 shadow border-top-purple">
                                        ...
                                        <tr v-for="(role, index) in roles.data" :key="index">
                                            ...
                                            <td class="text-center">
                                                <Link :href="`/apps/roles/${role.id}/edit`"
                                                    v-if="hasAnyPermission(['roles.update'])"
...
const handleSearch = () => {
    Inertia.get('/apps/roles', {
        //send params "q" from state "search"
        q: search.value,
    });
}
