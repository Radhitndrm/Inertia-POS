                                ...
                                <table class="table table-striped table-bordered table-hover">
                                    ...
                                    <tbody>
                                        <tr v-for="(product, index) in products.data" :key="index">
                                            ...
                                            <td>{{ product.title }}</td>
                                            <td class="text-center"><img :src="product.image" width="40"></td>
                                            ...
                                            <td class="text-center">
                                                <Link :href="`/apps/products/${product.id}/edit`"
                                                    v-if="hasAnyPermission(['products.update'])"
                                                    class="btn btn-success btn-sm me-2 mt-1"> <i
                                                    class="fa fa-pencil-alt me-1"></i> EDIT
                                                </Link>
                                                <button @click.prevent="destroy(product.id)"
                                                    v-if="hasAnyPermission(['products.delete'])"
                                                    class="btn btn-danger btn-sm mt-1"><i class="fa fa-trash"></i>
                                                    DELETE</button>
                                            </td>
                                        </tr>
                                    </tbody>
