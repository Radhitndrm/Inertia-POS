                                    ...
                                    <div class="row">
                                        <div class="col-md-4 mb-3" v-for="(product, index) in products.data" :key="index">
                                            <div class="card h-100 w-100 ">
                                                <button @click.prevent="selectProduct(product)" class="btn btn-white h-100">
...
export default {
    ...
    methods: {
        ...
        filterProducts() {
            Inertia.get('/apps/pos-transactions', {
                q: this.search
            });
        },
    ...
    setup(props) {
        ...
        const addToCart = () => {
            if (selectedProductId.value) {
                // Kirim data ke server dengan selectedProductId
                Inertia.post('/apps/pos-transactions/addToCart', {
                    ...
                    onSuccess: () => {
                        ...
                        selectedProduct.value = '';
                        selectedProductId.value = '';
                        // set qty to "1" atau yang diperlukan
                        qty.value = 1;
                        ...
                        // Inertia.get('/apps/pos-transactions', {
                        //     q: search.value, // Sertakan parameter pencarian jika diperlukan
                        //     // Sertakan parameter halaman atau data lain yang diperlukan untuk tetap di halaman yang sama.
                        // });
                    },
                });
        ...
        const destroyCart = (cart_id) => {
            Inertia.post('/apps/pos-transactions/destroyCart', {
                cart_id: cart_id
            }, {
                onSuccess: () => {
        ...
        const storeTransaction = () => {
            ...
            //HTTP request
            axios.post('/apps/pos-transactions/store', {
                    ...
                    Swal.fire({
                        ...
                        .then(() => {
                            ...
                            setTimeout(() => {
                                ...
                                //print
                                window.open(`/apps/pos-transactions/print?invoice=${response.data.data.invoice}`, '_blank');
