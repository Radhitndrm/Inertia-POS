            ...
            <div class="fade-in">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        ...
                        <div v-if="hasAnyPermission(['dashboard.profits_today'])"
                            class="card border-0 rounded-3 shadow border-top-gray">
                            <div class="card-header">
                                <span class="font-weight-bolf"><i class="fa fa-chart-bar"></i> PENDING TRANSACTIONS</span>
                            </div>
                            <div class="card-body">
                                <h5 class="fw-bold text-red">{{ pending_transactions }}<a href="/apps/pendingTransactions"
