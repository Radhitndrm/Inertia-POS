<template>
    <ul class="c-sidebar-nav">
        ...
        <li class="c-sidebar-nav-item">
            <Link class="c-sidebar-nav-link" v-if="hasAnyPermission(['dashboard.index'])"
                :class="{ 'active': $page.url.startsWith('/apps/pendingTransactions') }" href="/apps/pendingTransactions">
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-minecart-loaded"
                viewBox="0 0 16 16">
                <path
            ...
            <span class="ms-2">Pending Transaction  </span>
            </Link>
        </li>
        ...
        <li class="c-sidebar-nav-item" v-if="hasAnyPermission(['transactions.index'])">
            ...
            <span class="ms-2">Barcode Transactions</span>
            </Link>
        </li>

        <li class="c-sidebar-nav-item" v-if="hasAnyPermission(['transactions.index'])">
            <Link class="c-sidebar-nav-link" href="/apps/pos-transactions"
                :class="{ 'active': $page.url.startsWith('/apps/pos-transactions') }">
            ...
            <span class="ms-2">Pos Transactions</span>
            </Link>
        </li>

        <li class="c-sidebar-nav-item" v-if="hasAnyPermission(['transactions.index'])">
            <Link class="c-sidebar-nav-link" href="/apps/pos-app-transactions"
                :class="{ 'active': $page.url.startsWith('/apps/pos-app-transactions') }">
            ...
            <span class="ms-2">Pos App Transactions</span>
            </Link>
        </li>
